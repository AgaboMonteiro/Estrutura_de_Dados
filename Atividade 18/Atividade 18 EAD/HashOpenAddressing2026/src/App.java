        ...
        do {
            ...
            switch (op) {
                ...
                case 3:
                    ...
                    chave = scanner.nextLong();
                    scanner.nextLine(); // Limpar o buffer
                    int comps = hashTable.containsKey(chave);
                    System.out.println("Busca realizada com " + comps + " comparacoes.");
                    break;
                ...
                case 4:
                    ...
                    // Implementação simples de alterar usando delete e put ou acesso direto
                    if (hashTable.deleteHash(chave)) {
            ...
            // System.out.print("\033[H\033[2J"); // Limpar a tela (comentado para ver saída no log)
            // System.out.flush();
        } while (op != 0);
